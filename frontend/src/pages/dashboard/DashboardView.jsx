 ...
 * Used for the "Dashboard" page of the navbar of the application
...
const HighchartsReact = HighchartsReactModule.HighchartsReact || HighchartsReactModule.default || HighchartsReactModule;
